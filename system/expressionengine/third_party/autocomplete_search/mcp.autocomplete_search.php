...
class Autocomplete_search_mcp {
  ...
  public function __construct()
  {
    ...
    $this->_base_url = BASE.AMP.'C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=autocomplete_search';
  ...
  public function index()
  {
    $this->EE->cp->set_variable('cp_page_title',
      lang('autocomplete_search_module_name'));
