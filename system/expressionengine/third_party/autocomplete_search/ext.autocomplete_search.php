...
class Autocomplete_search_ext {

	public $settings 		= array();
	public $description		= 'Autocompletes search';
	public $docs_url		= '';
	public $name			= 'Autocomplete Search';
	...
	public function activate_extension()
	{
        ...
        // $variables = include "install/autocomplete_search.inc.php";
    ...
    {
        $this->EE->autocomplete_search_lib->validate_email($errors, $object);
        return;
    }
